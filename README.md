...
附加说明：支持上下文关联，支持18轮对话内的上下文关联，超过18轮对话则重置。当replyStr值为”**核心接口鉴权失败，请重新登录。**“时表示当前token失效需要从新登录
...
| ------ | ------ | ----------------------------------------------- |
| askStr | String | 需要传送给AI的对话文本                          |
| token  | String | 当前用户的token，用以上下文关联和对核心接口鉴权 |
...
附加说明：支持上下文关联流式返回前端，支持18轮对话内的上下文关联，超过18轮对话则重置。当输出文本为”**核心接口鉴权失败，请重新登录。**“时表示当前token失效需要从新登录
